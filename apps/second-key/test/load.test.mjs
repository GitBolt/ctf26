...
test("one unauthenticated flood cannot deny 40 isolated participants while shared-payer work stays bounded", async (t) => {
  let active = 0;
  let maximum = 0;
  ...
  assert.equal(await service.store.provisionedCount(), 40);
