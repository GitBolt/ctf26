...
`CHALLENGE_TICKET_SECRET_OVERCLOCK` must equal this service's `CHALLENGE_TICKET_SECRET`; the ticket
audience remains `overclock` for compatibility while the public challenge name is DRIFT.
